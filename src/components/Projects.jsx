...
//       {/* featured projects */}
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-5 my-6 items-center jsutify-center">
//         {
//           projects.map((project, index) => <div key={index} className="flex flex-col shadow-sm md:w-[343px] bg-[#31313f] rounded">
...
//             {/* buttons */}
//             <div className="mt-5">
//               <button className="btn bg-primary py-2 text-white rounded hover:bg-white hover:text-primary transition-all duration-500">Site Link</button>
//               <button className="btn outline px-6 py-1.5 rounded border-none text-white ml-5">Github Repo</button>
//             </div>
//           </div>)
//         }
//       </div>
